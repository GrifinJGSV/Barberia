...
private int paginaActual = 1;
    ...
    private void btnAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAActionPerformed
        ...
        querys.setFechadeadquisicion(fech);// ojjo aqui
        ...
        if (MobiliarioYEquipo.Editar(querys)) {
         ...
         //   Controlador.MobiliarioYEquipo.MostrarMobiliarioyEquipo("", NORMAL, ALLBITS, estado);//ojo aqui
          //  Controlador.MobiliarioYEquipo.NumeroPages(fech, NORMAL, estado)
