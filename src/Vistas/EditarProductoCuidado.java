...
public class EditarProductoCuidado extends javax.swing.JFrame {
    ...
    public EditarProductoCuidado() {
        ...
        InputMap map1 = txtNombreP.getInputMap(JTextField.WHEN_FOCUSED);
        ...
        InputMap map3 = txtTamano.getInputMap(JTextField.WHEN_FOCUSED);
        map3.put(KeyStroke.getKeyStroke(KeyEvent.VK_V, Event.CTRL_MASK),"null");
        
        //código para bloquear el pegado en la descripcion
        InputMap map4 = txaDescripcion.getInputMap(JTextField.WHEN_FOCUSED);
    ...
    private void initComponents() {
        ...
        btnactualizar.setBackground(new java.awt.Color(255, 255, 254));
