...
public class IngresarCorte extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 60, 100, 120));
    ...
    if (!direccion.matches("[a-zA-Z0-9áéíóúñÁÉÍÓÚÑ][a-zA-Z0-9 áéíóúñÁÉÍÓÚÑü.:;,-]+")) {
        ...
        querys.setGenero(genero);
         ...
         if (nombre.length() < 4) {
        JOptionPane.showMessageDialog(null, "El nombre de corte debe tener al menos 4 letras", "Error de validación", JOptionPane.WARNING_MESSAGE);
        return; // Salir del método si el nombre es demasiado corto
    }
         if (direccion.length() < 10) {
        JOptionPane.showMessageDialog(null, "La descripciona debe tener al menos 10 letras", "Error de validación", JOptionPane.WARNING_MESSAGE);
        return; // Salir del método si el nombre es demasiado corto
    }
