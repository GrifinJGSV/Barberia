...
public class EmpleadosStore extends javax.swing.JFrame {
      ...
      /*  if(ideEmp.equals("0000-0000-00000")){
       ...
       String estaEmp = combo_estado.getSelectedItem().toString();
        ...
        // Salir del método si el nombre contiene caracteres no válidos
            ...
            if (nomEmp.length() < 5) {
        JOptionPane.showMessageDialog(null, "El nombre del empleado debe tener al menos 5 letras", "Error de validación", JOptionPane.WARNING_MESSAGE);
        return; // Salir del método si el nombre es demasiado corto
    }
         if (apeEmp.length() < 5) {
        JOptionPane.showMessageDialog(null, "El apellido del empleadodebe tener al menos 5 letras", "Error de validación", JOptionPane.WARNING_MESSAGE);
        return; // Salir del método si el nombre es demasiado corto
    }
           if (nomEme.length() < 10) {
        JOptionPane.showMessageDialog(null, "El nombre contacto de emergencia debe tener al menos 10 letras", "Error de validación", JOptionPane.WARNING_MESSAGE);
        return; // Salir del método si el nombre es demasiado corto
    }
            if (texdire.length() < 10) {
    ...
    private void txt_nombreKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_nombreKeyTyped
       ...
       if(Valor.length()>=30){
       JOptionPane.showMessageDialog(this, "el nombre no puede contener mas de 30 letras");
      evt.consume();
       }
        if (txt_nombre.getText().length() == 0 && evt.getKeyChar() == ' ') {
                    evt.consume();
                }      
         ...
         if(Character.isDigit(c)){
            ...
            int tam = txt_nombre.getText().length();
        if(tam>=30){
            evt.consume();
    ...
    private void txt_apellidoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_apellidoKeyTyped
      String Valor =txt_apellido.getText();
       ...
       if (Valor.startsWith(" ")){
             JOptionPane.showMessageDialog(this, "El apellido no puede iniciar con espacios ");// no puede iniciar con  espacios
          txt_apellido.setText(Valor);
          return;
        }
       if(Valor.length()>=30){
       JOptionPane.showMessageDialog(this, "El apellido no puede contener mas de 30 letras");
      evt.consume();
       }
        if (txt_apellido.getText().length() == 0 && evt.getKeyChar() == ' ') {
                    evt.consume();
                }      
         ...
         if(Character.isDigit(c)){
            ...
            int tam = txt_apellido.getText().length();
        if(tam>=30){
            evt.consume();
        }  else if((int)evt.getKeyChar()>32 && (int)evt.getKeyChar()<=47
                ||(int)evt.getKeyChar()>=58 && (int)evt.getKeyChar()<=64
    ...
    private void txt_NomEmeKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_NomEmeKeyTyped
       ...
       if(Valor.length()>=30){
       JOptionPane.showMessageDialog(this, "El nombre de contacto de emergenciano puede contener mas de 30 letras");
      evt.consume();
       }
        if (txt_NomEme.getText().length() == 0 && evt.getKeyChar() == ' ') {
                    evt.consume();
                }      
 ...
 if (evt.getKeyCode() == KeyEvent.VK_V && (evt.getModifiers() & KeyEvent.CTRL_MASK) != 0) {
    ...
    private void tex_direccionKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tex_direccionKeyPressed
 if (evt.getKeyCode() == KeyEvent.VK_V && (evt.getModifiers() & KeyEvent.CTRL_MASK) != 0) {
        Clipboard clipboard = Toolkit.getDefaultToolkit().getSystemClipboard();
        Transferable contents = clipboard.getContents(null);
    ...
    }//GEN-LAST:event_tex_direccionKeyPressed

    private void txt_NomEmeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_NomEmeKeyPressed
 if (evt.getKeyCode() == KeyEvent.VK_V && (evt.getModifiers() & KeyEvent.CTRL_MASK) != 0) {
        Clipboard clipboard = Toolkit.getDefaultToolkit().getSystemClipboard();
        Transferable contents = clipboard.getContents(null);
