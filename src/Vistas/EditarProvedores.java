       ...
       if (telProv.equals("0000-0000")) {
        ...
        if (!desProv.matches("[a-zA-Záéíóúñ.,;:-_ 0-9][a-zA-Záéíóúñ.,;.;-_ 0-9]+")) {
            ...
            querys.setId(idTxt);
             ...
             if (nomProv.length() < 10) {
        JOptionPane.showMessageDialog(null, "El nombre de representante debe tener al menos 10 letras", "Error de validación", JOptionPane.WARNING_MESSAGE);
        return; // Salir del método si el nombre es demasiado corto
    }
         if (empProv.length() < 4) {
        JOptionPane.showMessageDialog(null, "El nombre de la empresa debe tener al menos 4 letras", "Error de validación", JOptionPane.WARNING_MESSAGE);
        return; // Salir del método si el nombre es demasiado corto
    }
           if (desProv.length() < 10) {
        JOptionPane.showMessageDialog(null, "La dirección debe tener al menos 10 letras", "Error de validación", JOptionPane.WARNING_MESSAGE);
        return; // Salir del método si el nombre es demasiado corto
    }
...
if (evt.getKeyCode() == KeyEvent.VK_V && (evt.getModifiers() & KeyEvent.CTRL_MASK) != 0) {
    ...
    private void txta_direccionKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txta_direccionKeyPressed
if (evt.getKeyCode() == KeyEvent.VK_V && (evt.getModifiers() & KeyEvent.CTRL_MASK) != 0) {
        Clipboard clipboard = Toolkit.getDefaultToolkit().getSystemClipboard();
        Transferable contents = clipboard.getContents(null);
    ...
    }//GEN-LAST:event_txta_direccionKeyPressed
